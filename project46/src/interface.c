...
create_mod (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), button_mod, 344, 632);
  ...
  label41 = gtk_label_new (_("Description :"));
  gtk_widget_show (label41);
  gtk_fixed_put (GTK_FIXED (fixed2), label41, 40, 464);
  gtk_widget_set_size_request (label41, 112, 24);

  mod5 = gtk_entry_new ();
  gtk_widget_show (mod5);
  gtk_fixed_put (GTK_FIXED (fixed2), mod5, 184, 464);
...
create_af (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), button5, 552, 504);
  gtk_widget_set_size_request (button5, 88, 40);
  ...
  GLADE_HOOKUP_OBJECT (af, alignment14, "alignment14");
...
create_aj (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), button_aj, 344, 472);
